...
#setting directory - Sean revise to your directory
setwd("/Users/robertandrus/Google Drive/Spring 2018/Projects/burn severity paper/RR_DEM/") 

#importing RdNBR
RdNBR = raster("RedRockFire_Indices/RR_RdNBR.tif")
#importing shapefile for fire perimeter
perim <- readOGR(dsn = "/Users/robertandrus/Google Drive/Spring 2018/Projects/burn severity paper/RR_DEM/RedRockFire_Indices/", layer = "RR_firePerimeter")
#physical vars
elev = raster("RR_DEM_v2.tif")
slp = raster("RR_Slope.tif")
asp = raster("RR_aspect.tif")
#prefire NBR
preNBR = raster("/Users/robertandrus/Google Drive/Spring 2018/Projects/burn severity paper/RR_DEM/RedRockFire_Indices/RR_prefire_NBR.tif")
...
#exporting df
write.csv(data, file = "RedRocks_data_Fig6.csv")
