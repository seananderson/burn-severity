...
ggsave(here("map/map-cred2-Q2.png"), width = 3.9, height = 7.9, dpi = 220)
...
select(xx, x, y, response, pp_est, p0_est, p1_est, q0.50) %>%
  ...
  geom_text(data = lets2, aes(label = panel, x = x, y = y), 
    inherit.aes = FALSE, col = "grey30")
ggsave(here("map/map-components-Q2.png"), width = 4, height = 7.5, dpi = 200)
```
...
ggsave(here("map/map-cred2-Q2-diff.png"), width = 4, height = 9, dpi = 220)
```
