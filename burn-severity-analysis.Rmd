...
ggsave("figs/fig2.png", width = 8.2, height = 4.5, dpi = 220)
```
...
ggsave("figs/q2-coefs-facets.png", width = 7.2, height = 5.4)
...
ggsave("figs/q3-coefs-facets.png", width = 7.2, height = 5.4)
